...
df = pd.read_csv("/Users/new/Documents/PythonBYJUProjects/PRO-C111/medium_data.csv")

data = df['reading_time'].tolist()

population_mean = statistics.mean(df["reading_time"])
print("Mean of the total data is: ")
print(population_mean)

population_std_deviation = statistics.stdev(data)
print("Standard deviation of the total data is: ")
...
print("The new intervention of the total data is: ",new_data_mean)
